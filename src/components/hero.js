...
export default function Hero() {
  return (
    ...
    >
      <div className="flex flex-col gap-16 sm:gap-7 pt-3 md:w-1/2 md:gap-6 lg:p-0 lg:g-5" >
        <div className="flex flex-col px-3 gap-5 sm:gap-7 md:gap-7 ">
        ...
        <div className="flex justify-center items-center sm:p-10">
          <button className="p-2 bg-red-600 rounded-xl sm:rounded-md md:px-5 lg:px-8 lg:rounded-lg">Dowload CV</button>
        </div>
      </div>
